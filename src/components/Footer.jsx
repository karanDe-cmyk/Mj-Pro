        ...
        <>
            <footer className="bg-gray-900 text-gray-300">
                <div className="max-w-7xl mx-auto py-8 px-4 overflow-hidden sm:px-6 lg:px-8">
                    ...
                    <p className="mt-8 text-center text-base">Our website is operated by MJ Pro International B.V., a company established under the laws of United Kingdom, with registered address at #506 IT Park Towers Cambridge CB2 1TN, United Kingdom, and having its gaming sublicence issued, by United Kingdom e-Gaming and all rights to operate the gaming software worldwide.</p>
                    <p className="mt-8 text-center text-base">Copyright MJ Pro | All rights reserved</p>
                </div>
            </footer>
        </>
    );
