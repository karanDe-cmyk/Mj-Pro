    ...
    <div className="bg-gray-50 min-h-screen pt-20 pb-10 px-4 text-gray-800"> {/* Main container for light theme */}
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-center text-blue-700">
          {selectedGameName} <span className="text-gray-800">Panna Chart</span>
        </h1>
        <p className="text-sm mb-6 text-gray-600 text-center">
          Historical Data and Results for {selectedGameName} Panna
        </p>
          ...
          <table className="table-auto w-full text-center text-xs sm:text-sm">
            <thead className="bg-blue-700 text-white">
              <tr>
                ...
                <th className="border-r border-blue-600 px-3 py-2 sm:px-4 sm:py-2">Open</th>
                <th className="border-r border-blue-600 px-3 py-2 sm:px-4 sm:py-2">Jodi</th>
                <th className="px-3 py-2 sm:px-4 sm:py-2">Close</th>
              </tr>
            </thead>
            <tbody>
              {dataSource.length > 0 ? (
                dataSource.map((d, index) => (
                  <tr key={index} className="border-t border-gray-200 even:bg-gray-100">
                    ...
                    <td className="border-r border-gray-200 px-3 py-2 sm:px-4 sm:py-2 text-blue-600 font-semibold">{d.open}</td>
                    <td className="border-r border-gray-200 px-3 py-2 sm:px-4 sm:py-2 text-red-600 font-bold text-base sm:text-lg">{d.jodi}</td>
                    <td className="px-3 py-2 sm:px-4 sm:py-2 text-blue-600 font-semibold">{d.close}</td>
                  </tr>
                ))
              ) : (
                <tr>
